...
public class OrderDetailsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        services.GetOrderdetails_Service service = new services.GetOrderdetails_Service();
       services.GetOrderdetails port = service.getGetOrderdetailsPort();
         port.getOrderdetails(); 
     PrintWriter out = response.getWriter();
    // out.print(port.getOrderdetails());
      request.setAttribute("msg1",port.getOrderdetails());    
